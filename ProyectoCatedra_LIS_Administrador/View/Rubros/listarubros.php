...
<div class="container">
    ...
    <div class="row">
      ...
      <table class="table table-striped table-bordered table-hover" id="tabla">
                    ...
                    ?>
                    <tr>
                        <td><?=$rubro['cod_rubro']?></td>
                        <td><?=$rubro['nombre']?></td>
                        <td>
                                    <a title="Editar" class="btn btn-primary btn-circle" href="/ProyectoCatedra_LIS_Administrador/Rubros/edit/<?=$rubro['cod_rubro']?>">Editar</span></a>
                                    <a title="Eliminar"  class="btn btn-danger btn-circle" href="/ProyectoCatedra_LIS_Administrador/Rubros/remover/<?=$rubro['cod_rubro']?>">Eliminar</a>
                        </td>
                    </tr>
                    <?php
                    }
