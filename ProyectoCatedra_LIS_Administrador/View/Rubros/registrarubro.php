...
<div class="container">
            ...
            <div class="row">
                <div class=" col-md-7">
                    ...
                    ?>
                   <form role="form" action="/ProyectoCatedra_LIS_Administrador/Rubros/agregarRubro" method="POST">
                    <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Campos requeridos</strong></div>
                        <div class="form-group col-md-6">
                            <label for="codigo">Codigo del Rubro:</label>
                            <div class="input-group">
                                <input type="number" class="form-control" name="cod_rubro" id="codigo_rubro" placeholder="Ingresa un codigo de rubro" min="1">
