    ...
    <div class="col-md-6 mx-auto">
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <h2 class="card-text">Registrar empleado de "La cuponera"</h2>
            ...
            <div class="card-body">
                <form method="post" action="/ProyectoCatedra_LIS_Administrador/Usuarios/addEmployee">
                    <div class="form-group">
                        <label>Codigo de Empleado<sub>*</sub></label>
                        <input type="text" name="cod_empleado" class="form-control form-control-lg" value="<?= isset($empleado)?$empleado['cod_empleado']:'' ?>" placeholder="Ingrese un codigo de empleado de la forma (AB1234)">
                    </div>
                    <div class="form-group">
                        <label>Nombre<sub>*</sub></label>
                        <input type="text" name="nombre" class="form-control form-control-lg" value="<?= isset($empleado)?$empleado['nombre']:'' ?>" placeholder="Ingrese su nombre">
                    </div>
                    <div class="form-group">
                        <label>Apellido<sub>*</sub></label>
                        <input type="text" name="apellido" class="form-control form-control-lg" value="<?= isset($empleado)?$empleado['apellido']:'' ?>" placeholder="Ingrese su apellido">
                    </div>
                    <div class="form-group">
                        <label>Correo<sub>*</sub></label>
                        <input type="email" name="correo" class="form-control form-control-lg" value="<?= isset($empleado)?$empleado['correo']:'' ?>" placeholder="Ingrese su correo">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="/ProyectoCatedra_LIS_Administrador/Usuarios/login" class="btn btn-light btn-block pull-right">Ya tienes una cuenta? Login </a>
                            </div>
                        </div>
                    </div>
                </form>
