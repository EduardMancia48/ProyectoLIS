		...
		<div class="container">
			<div id="menubuttons">
				<div class="col-md-2 d-block mx-auto" id="uno">
					<a class="btn btn-block btn-lg btn-success" data-toogle="modal" data-target="#mymodal" href="/ProyectoCatedra_LIS_Administrador/Empresas/verRegistroEmpresa" target="_self" title="Nueva empresa">
						<img src="\ProyectoCatedra_LIS_Administrador\View\assets\images\logo-agregar.png" width="100" height="75"><br>
						<span class="texto_grande">Nueva empresa ofertante</span>
					</a> 
				</div>
        <br>
				<div class="col-md-2 d-block mx-auto" id="dos">
					<a class="btn btn-block btn-lg btn-danger" datatoggle="modal" data-target="#mymodal" href="/ProyectoCatedra_LIS_Administrador/Empresas/listaEmpresas" target="_self" title="Consultar datos">
						<img src="\ProyectoCatedra_LIS_Administrador\View\assets\images\logo-consulta.png" width="100" height="75"><br>      
						<span class="texto_grande">Ver registros de empresas</span>
					</a>  
				</div>
        <br>
        <div class="col-md-2 d-block mx-auto" id="dos">
					<a class="btn btn-block btn-lg btn-danger" datatoggle="modal" data-target="#mymodal" href="/ProyectoCatedra_LIS_Administrador/Empresas/listaOfertas" target="_self" title="Consultar datos">
						<img src="\ProyectoCatedra_LIS_Administrador\View\assets\images\logo-consulta.png" width="100" height="75"><br>      
						<span class="texto_grande">Ver promociones de empresas</span>
					</a>  
				</div>
        <br>
      </div>
