...
<div class="container">
            ...
            <div class="row">
                <div class=" col-md-7">
                    ...
                    ?>
                   <form role="form" action="/ProyectoCatedra_LIS_Administrador/Empresas/agregarEmpresa" method="POST">
                    <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Campos requeridos</strong></div>
                        <div class="form-group col-md-6">
                            <label for="codigo">Codigo de empresa:</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="cod_empresa" id="codigo_empresa" placeholder="Ingresa un codigo de empresa (ABC###)" value="<?= isset($empresa)?$empresa['cod_empresa']:'' ?>">
